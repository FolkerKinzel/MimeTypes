...
public readonly partial struct MimeTypeParameterInfo : IComparable<MimeTypeParameterInfo>
{
    ...
    /// <remarks>The method takes only the <see cref="MimeTypeParameterInfo.Key"/>s into account.</remarks>
    public int CompareTo(MimeTypeParameterInfo other) => Key.CompareTo(other.Key, StringComparison.OrdinalIgnoreCase);
}
