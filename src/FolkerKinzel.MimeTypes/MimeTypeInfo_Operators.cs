...
{
    /// <summary>
    /// Returns a value that indicates whether two specified <see cref="MimeTypeInfo"/> 
    /// instances are equal. The <see cref="Parameters"/> are taken into account.
    /// </summary>
    ...
    /// <summary>
    /// Returns a value that indicates whether two specified <see cref="MimeTypeInfo"/> 
    /// instances are not equal. The <see cref="Parameters"/> are taken into account.
    /// </summary>
    /// <param name="info1">The first <see cref="MimeTypeInfo"/> to compare.</param>
    /// <param name="info2">The second <see cref="MimeTypeInfo"/> to compare.</param>
    /// <returns><c>true</c> if <paramref name="info1"/> and <paramref name="info2"/> are
