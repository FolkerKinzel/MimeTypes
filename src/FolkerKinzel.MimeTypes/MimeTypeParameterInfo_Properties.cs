...
public readonly partial struct MimeTypeParameterInfo
{
    ...
    private int KeyValueOffset
        => IsEmpty
            ? 0
            : ((_idx >> KEY_VALUE_OFFSET_SHIFT) & KEY_VALUE_OFFSET_MAX_VALUE) + EQUALS_SIGN_LENGTH;
    ...
    /// <summary>
    /// Indicates whether the <see cref="MimeTypeParameterInfo"/> has the <see cref="Key"/>
    /// "charset". The comparison is case-insensitive.
    /// </summary>
