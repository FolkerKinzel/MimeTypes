...
{ 
    ...
    public void FromFileTypeExtensionTest1(string mimeType, string extension) => Assert.AreEqual(mimeType, MimeConverter.FromFileName(extension));
    ...
    [DataRow("    ", ".bin")]
    public void GetFileTypeExtensionTest1(string mimeType, string extension) => Assert.AreEqual(extension, MimeConverter.ToFileTypeExtension(mimeType));


    [TestMethod]
    public void GetFileTypeExtensionTest2()
    {
        string ext = MimeConverter.ToFileTypeExtension("text/plain; charset=utf-8".AsSpan());
    ...
    {
        string ext = MimeConverter.ToFileTypeExtension(ReadOnlySpan<char>.Empty, false);
