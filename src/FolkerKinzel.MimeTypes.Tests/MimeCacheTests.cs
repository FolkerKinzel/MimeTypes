...
public class MimeCacheTests
{
    ...
    {
        MimeCache.Clear();
        string ext = MimeCache.GetFileTypeExtension("image/jpeg");
        Assert.AreEqual(".jpg", ext);
        string mime = MimeCache.GetMimeType(".odt".AsSpan());
    ...
    public void GetMimeTypeTest1(string mimeType, string extension) => Assert.AreEqual(mimeType, MimeCache.GetMimeType(extension));

    #endregion

    #region GetExtensionTest
    [DataTestMethod]
    [DataRow("text/html", ".htm")]
    [DataRow("text/javascript", ".js")]
    [DataRow("text/cache-manifest", ".appcache")]
    ...
    public void GetFileTypeExtensionTest1(string mimeType, string extension) => Assert.AreEqual(extension, MimeCache.GetFileTypeExtension(mimeType));
