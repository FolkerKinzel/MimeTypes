...
public class MimeStringTests
{
    ...
    [DataRow("application/x-pkcs7-certificates", ".spc")]
    ...
    [DataRow("video/mp2t", ".ts")]
    [DataRow("video/mp2t", ".m2t")]
    [DataRow("video/mp2t", ".m2ts")]
    [DataRow("video/mp2t", ".mts")]
    ...
    [DataRow("application/x-x509-ca-cert", ".pem")]
    [DataRow("application/vnd.apple.keynote", ".key")]
    [DataRow("application/pkcs10", ".csr")]
    [DataRow("application/octet-stream", ".img")]
    ...
    [DataRow("font/ttf", ".tte")]
    [DataRow("font/ttf", ".dfont")]
    ...
    [DataRow("application/x-redhat-package-manager", ".rpm")]
    ...
    [DataRow("application/pgp-keys", ".asc")]
    ...
    [DataRow("application/x-msdos-program", ".exe")]
    ...
    [DataRow("    ", ".bin")]
    public void GetFileTypeExtensionTest1(string mimeType, string extension) => Assert.AreEqual(extension, MimeString.ToFileTypeExtension(mimeType));


    [TestMethod]
    public void GetFileTypeExtensionTest2()
    {
        string ext = MimeString.ToFileTypeExtension("text/plain; charset=utf-8".AsSpan());
